...
class OptionsNEnemies:
    def __init__(self, exit_to_lobby_callback: Callable[[], None]) -> None:
        ...
        button_start_game = Button(x=195, y=550,
                                   ...
                                   text='Начать игру')
        button_count_enemies = Button(x=40, y=450,
                                      width=290, height=80,
                                      size=30,
                                      color=(255, 255, 255), hover_color=(185, 186, 189),
                                      function=self.change_count,
                                      args=(40, 450),
                                      text=f'Количество противников: {self.count_enemies}')
    ...
    def change_count(self, pos: Tuple[int, int]) -> None:
        ...
        """
        if self.count_enemies == 5:
            self.count_enemies = 2
        else:
    ...
    def start_game(self, args: Optional[Tuple] = None) -> None:
        ...
        self.new_game = NEnemiesMode(self.count_enemies, f'images/{theme}', self.exit_to_lobby_callback, self.exit_to_options)
        self.new_game.run()
    ...
    def exit_to_options(self) -> None:
        ...
        """
        self.options_window.on_close()
        back_to_options: OptionsNEnemies = OptionsNEnemies(self.exit_to_lobby_callback)
    ...
    def run_options(self) -> None:
        ...
        while self.options_window.running:
            ...
            self.options_window.draw_text("Нажмите, чтобы изменить", 55, 454, 30, (0, 0, 0))
